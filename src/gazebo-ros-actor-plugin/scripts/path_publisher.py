...
def input_pose(path_msg, pose):
    if path_msg.poses != None:
...
def publish_path():
    ...
    for i in range(num_waypoints):
        ...
        input_pose(path_msg, pose)
    
    input_pose(path_msg, make_pose(0, 0, 0, 0))
    input_pose(path_msg, make_pose(0, 0, 5, 0))
